<%-- 
    ...
    Created on : May 24, 2017, 10:17:04 PM
...
<html>
    ...
    <body>
        <header>
            ...
            <h2>This is the desktop browser home page. It looks better on a mobile device!</h2>
        </header>
        <main>
            <form action="${pageContext.request.contextPath}/desktopResults.jsp" method="post">
                <table class="keypad">
                    <tr>
